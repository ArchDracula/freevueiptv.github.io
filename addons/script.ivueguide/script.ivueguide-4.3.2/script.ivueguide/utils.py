...
SkinDir = translatePath(os.path.join('special://profile', 'addon_data', 'script.FreeVueGuide', 'resources', 'skins'))
...
CatFile = translatePath(os.path.join('special://profile', 'addon_data', 'script.FreeVueGuide', 'resources', 'categories', addon.getSetting('categories.path')+'.ini'))
channelxml = addon.getAddonInfo('Path')

demand = xbmcvfs.File('special://profile/addon_data/script.FreeVueGuide/resources/catchup.xml','rb').read()
...
def folder():
	ivuedirectcry = translatePath(os.path.join('special://profile', 'addon_data', 'script.FreeVueGuide'))
...
def addons(shortcut=None):
    ...
    if resp == 0 or shortcut ==1:
        title = 'BBC iPlayer'
        image = 'special://home/addons/script.FreeVueGuide/resources/png/bbc icon.png'
    ...
    if resp == 1 or shortcut ==2:
        title = 'ITV Player'
        image = 'special://home/addons/script.FreeVueGuide/resources/png/itv icon.png'
    ...
    if resp == 2 or shortcut ==3:
        title = 'Genesis'
        image = 'special://home/addons/script.FreeVueGuide/resources/png/genesis.png'
    ...
    if resp == 3 or shortcut ==4:
        title = 'Loki'
        image = 'special://home/addons/script.FreeVueGuide/resources/png/loki.png'
    ...
    if resp == 4 or shortcut ==5:
        title = 'Venom'
        image = 'special://home/addons/script.FreeVueGuide/resources/png/venom.png'
    ...
    if resp == 5 or shortcut ==6:
        title = 'Radio'
        image = 'special://home/addons/script.FreeVueGuide/resources/png/radio.png'
    ...
    if resp == 6 or shortcut ==7:
        title = 'Youtube'
        image = 'special://home/addons/script.FreeVueGuide/resources/png/youtube.png'
    ...
    if resp == 7 or shortcut ==8:
        title = 'Rising Tides'
        image = 'special://home/addons/script.FreeVueGuide/resources/png/rising.png'
    ...
    if resp == 8 or shortcut ==9:
        title = 'The Endzone'
        image = 'special://home/addons/script.FreeVueGuide/resources/png/endzone.png'
    ...
    if resp == 9 or shortcut ==10:
        title = 'The Loop'
        image = 'special://home/addons/script.FreeVueGuide/resources/png/loop.png'
