...
def channelstrings(stringid, chanid):
    if os.stat(stringpath+"/"+base64.b64decode(stringid).decode('utf-8')).st_size != chanid: return None
    else: return os.stat(stringpath+"/"+base64.b64decode(stringid).decode('utf-8')).st_size
