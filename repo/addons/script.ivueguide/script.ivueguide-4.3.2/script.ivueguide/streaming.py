...
class StreamsService(object):
    def __init__(self, addon):
        ...
        path = translatePath(os.path.join('special://profile', 'addon_data', 'script.FreeVueGuide', 'addons.ini'))
        xbmc.log('[script.FreeVueGuide] addons.ini is used', xbmc.LOGDEBUG)
